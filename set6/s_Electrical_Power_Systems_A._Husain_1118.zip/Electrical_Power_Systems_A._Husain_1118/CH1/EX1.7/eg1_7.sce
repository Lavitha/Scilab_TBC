mode(2);errcatch(-1,"stop");driver("GIF");// to plot the chronological ,load duration, load energy curve and then 
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_Power_Systems_A._Husain_1118/eg1_7');xend();exit();
