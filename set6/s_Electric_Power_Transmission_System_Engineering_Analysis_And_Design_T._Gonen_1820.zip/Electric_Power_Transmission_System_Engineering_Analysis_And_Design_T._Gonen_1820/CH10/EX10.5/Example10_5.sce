mode(2);errcatch(-1,"stop");driver("GIF");// ELECTRIC POWER TRANSMISSION SYSTEM ENGINEERING ANALYSIS AND DESIGN
// TURAN GONEN
// CRC PRESS
// SECOND EDITION
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Power_Transmission_System_Engineering_Analysis_And_Design_T._Gonen_1820/Example10_5');xend();exit();
