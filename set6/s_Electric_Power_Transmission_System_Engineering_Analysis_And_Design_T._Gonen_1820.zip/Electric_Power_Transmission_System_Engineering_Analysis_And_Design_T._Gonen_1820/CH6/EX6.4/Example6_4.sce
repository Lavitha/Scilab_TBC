errcatch(-1,"stop");mode(2);// ELECTRIC POWER TRANSMISSION SYSTEM ENGINEERING ANALYSIS AND DESIGN
// TURAN GONEN
// CRC PRESS
// SECOND EDITION
...
printf("\n (a) Commutating reactance When all three breakers are d, X_C = %.4f Ω \n",X_C) ; 
