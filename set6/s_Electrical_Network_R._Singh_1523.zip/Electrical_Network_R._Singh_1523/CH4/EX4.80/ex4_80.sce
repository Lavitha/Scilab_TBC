mode(2);errcatch(-1,"stop");driver("GIF");//AC Circuits : example 4.80 :(pg 4.65)
R=10;
L=0.2;
C=40*10^-6;
V=100;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_Network_R._Singh_1523/ex4_80');xend();exit();
