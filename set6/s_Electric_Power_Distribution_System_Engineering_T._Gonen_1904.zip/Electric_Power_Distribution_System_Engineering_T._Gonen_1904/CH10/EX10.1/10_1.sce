errcatch(-1,"stop");mode(2);//To Determine the necessary realy and rer coordination
//Page 542
;
;
...
RerOT=1; //Assumed Rer Open Time

RelayCTI=InstT/PickU; //Relay Closing Travel during instantaneous operation
RelayRTI=(-1)*RerOT/Reset; //Relay Reset Travel during instantaneuos

RelayCTD=TimeD/PickU;
RelayRTD=(-1)*RerOT/Reset; //Relay Reset Travel during trip
