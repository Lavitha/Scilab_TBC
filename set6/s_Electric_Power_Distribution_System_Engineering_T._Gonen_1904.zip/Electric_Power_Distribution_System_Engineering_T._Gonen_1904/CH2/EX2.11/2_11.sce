mode(2);errcatch(-1,"stop");driver("GIF");//To determine the Thirty min maximum diversified
//Page 62
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Power_Distribution_System_Engineering_T._Gonen_1904/2_11');xend();exit();
