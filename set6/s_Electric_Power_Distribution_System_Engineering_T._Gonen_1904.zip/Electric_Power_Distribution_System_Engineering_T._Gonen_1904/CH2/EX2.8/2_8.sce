mode(2);errcatch(-1,"stop");driver("GIF");//To determine the annual load factor on the substation
//Page 57
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Power_Distribution_System_Engineering_T._Gonen_1904/2_8');xend();exit();
