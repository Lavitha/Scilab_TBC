mode(2);errcatch(-1,"stop");driver("GIF");//To Determine the Conditional Outage Probabilites
//Page 620
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Power_Distribution_System_Engineering_T._Gonen_1904/11_8');xend();exit();
