errcatch(-1,"stop");mode(2);// To calculate the critical ing angle for the generator for a 3-phase fault
...
Zgb=%i*.3+ %i*(.55) +%i*.15;//Reactance between the generator and infinite bus after the fault is ed (p.u)
...
mprintf("The critical ing angle is given by= %.1f ",dc);
