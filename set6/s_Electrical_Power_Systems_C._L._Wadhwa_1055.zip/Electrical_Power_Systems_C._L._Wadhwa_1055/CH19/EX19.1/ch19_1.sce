errcatch(-1,"stop");mode(2);// To Determine the economic operating schedule and the corresponding cost of generation.(b)Determine the savings obtained by loading the units.
