mode(2);errcatch(-1,"stop");driver("GIF");//Determine the first four terms in the Fourier series for a rectangular waveform
...
y=sin(x);
plot(x,y);
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Communication_Systems_G._Kennedy_And_B._Davis_63/Exa1_1.sci');xend();exit();
