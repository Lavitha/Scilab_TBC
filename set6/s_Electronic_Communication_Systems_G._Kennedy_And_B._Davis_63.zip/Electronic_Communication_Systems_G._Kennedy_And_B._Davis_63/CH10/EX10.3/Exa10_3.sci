errcatch(-1,"stop");mode(2);//Determine (a) The cutoff wavelength for the dominant mode (b) The wavelength in a waveguide, also for the dominant mode (c) The corresponding ground and phase velocities
