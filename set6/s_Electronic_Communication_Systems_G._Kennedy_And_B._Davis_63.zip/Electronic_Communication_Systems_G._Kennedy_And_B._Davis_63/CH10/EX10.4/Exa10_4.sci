errcatch(-1,"stop");mode(2);//Determine the greatest number of half-waves of electric intensity which it will be possible to establish between the two walls and also determine the guide wavelength for this mode of propagation
vc = 3e+10;
f = 10e+9;
d = 6;
m1 = 1;
