errcatch(-1,"stop");mode(2);//Determine the cut-off wavelength, the guide wavelength, the group and phase velocities and the char. wave impediance for (a) the TE10 mode and (b) the TM11 mode
