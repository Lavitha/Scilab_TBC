errcatch(-1,"stop");mode(2);//Caption:Find the (1)external resistance (2)breaking torque (a) at the instant of plugging (b)when the speed of motor approaches zero
//Exa:6.9
;
;
