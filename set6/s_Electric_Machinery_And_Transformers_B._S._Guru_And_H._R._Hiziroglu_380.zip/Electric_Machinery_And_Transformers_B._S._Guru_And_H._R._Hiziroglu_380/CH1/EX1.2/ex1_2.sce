mode(2);errcatch(-1,"stop");driver("GIF");//Caption:Finding the current in the circuit and plot V vs T and I vs T curve
//Exa:1.2
clc;
clear;
...
y=14.142*cos(1000*x);
plot(x,y);
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Machinery_And_Transformers_B._S._Guru_And_H._R._Hiziroglu_380/ex1_2');xend();exit();
