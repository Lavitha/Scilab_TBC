errcatch(-1,"stop");mode(2);//Caption:Find the (a)induced emf in the armature winding (b)induced emf per coil (c)induced emf per turn (d)induced emf per conductor
//Ex:5.3
;
;
