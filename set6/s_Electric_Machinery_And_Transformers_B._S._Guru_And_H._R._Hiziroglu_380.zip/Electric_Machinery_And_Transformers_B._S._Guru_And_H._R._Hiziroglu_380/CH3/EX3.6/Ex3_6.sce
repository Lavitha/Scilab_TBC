errcatch(-1,"stop");mode(2);//Caption:Find the (a) frequency of induced emf (b)max value of induced emf  (c)rms value of induced emf  (d)average value of induced emf
//Exa:3.6
;
;
