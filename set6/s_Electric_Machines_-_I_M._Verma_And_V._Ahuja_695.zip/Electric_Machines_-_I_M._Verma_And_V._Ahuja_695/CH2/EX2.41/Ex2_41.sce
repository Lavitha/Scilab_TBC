errcatch(-1,"stop");mode(2);//Caption:Calculate the value of external resistance when (a)the load torque is independent of speed (b)the load torque is proportional to speed (c)the load torque varies as square of the speed
//Exa:2.41
;
;
