errcatch(-1,"stop");mode(2);//Caption:Calculate the core loss and copper loss and also find the value of load current at which max efficiency will be attained
//Exa:3.23
;
;
