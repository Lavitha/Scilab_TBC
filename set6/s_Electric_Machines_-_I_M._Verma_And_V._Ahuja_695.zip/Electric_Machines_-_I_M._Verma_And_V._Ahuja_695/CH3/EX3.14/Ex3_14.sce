errcatch(-1,"stop");mode(2);//Caption:Calculate the parameters reffered to LV Side and also find the voltage regulation at full load and efficiency of transformer at full load and half load at 0.8pf lagging
//Exa:3.14
;
;
