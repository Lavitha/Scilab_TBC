errcatch(-1,"stop");mode(2);//Caption:Find the (a)iron loss (b)copper loss at full load (c)Load KVA at which maximum efficiency occurs (d)maximum efficiency of transformer at 0.8pf lagging
//Exa:3.19
;
;
