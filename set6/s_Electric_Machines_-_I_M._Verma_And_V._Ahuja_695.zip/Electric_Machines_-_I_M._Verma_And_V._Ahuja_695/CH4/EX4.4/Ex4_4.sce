errcatch(-1,"stop");mode(2);//Caption:Find the value of line voltage,line current,and output when the transformer winding is connected as (a) Star-delta (b)delta-star
//Exa:4.4
;
;
