mode(2);errcatch(-1,"stop");driver("GIF");//to calculate syn chronous reactance ,leakage reactance,voltage regulation
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Machines_D._P._Kothari_And_I._J._Nagrath_503/ch8_3.sci');xend();exit();
