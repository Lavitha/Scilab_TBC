mode(2);errcatch(-1,"stop");driver("GIF");//to determine shunt field current of the motor,demagnetising effect of armature rxn, determine series field turns/pole,speed of motor.
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Machines_D._P._Kothari_And_I._J._Nagrath_503/ch7_42.sci');xend();exit();
