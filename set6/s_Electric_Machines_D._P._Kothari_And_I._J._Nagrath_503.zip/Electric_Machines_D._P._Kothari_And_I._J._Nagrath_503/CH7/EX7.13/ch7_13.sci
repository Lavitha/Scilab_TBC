mode(2);errcatch(-1,"stop");driver("GIF");//to calculate mmf per pole and speed at no load(rpm)
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Machines_D._P._Kothari_And_I._J._Nagrath_503/ch7_13.sci');xend();exit();
