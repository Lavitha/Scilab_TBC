mode(2);errcatch(-1,"stop");driver("GIF");//to find the range of generator field current,motor current and speed
...
xinit('/home/fossee/Downloads/tbc_graphs/Electric_Machines_D._P._Kothari_And_I._J._Nagrath_503/ch7_56.sci');xend();exit();
