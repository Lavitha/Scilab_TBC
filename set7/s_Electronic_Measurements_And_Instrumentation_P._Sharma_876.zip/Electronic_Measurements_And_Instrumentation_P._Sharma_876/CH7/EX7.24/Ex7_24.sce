errcatch(-1,"stop");mode(2);//caption:Find (a)resolution of the voltmeter(b)display of 16.58 in voltmeter on the 10V range(c)display of 0.7254 in voltmeter on the 1V and 10V range
//Ex7.24
