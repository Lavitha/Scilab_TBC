errcatch(-1,"stop");mode(2);//caption:Find reading of voltmeter and percentage error when(a)sensitivity of voltmeter is 100 kilo ohm per volt(b)sensitivity of voltmeter is 500 kilo ohm per volt
//Ex5.10
