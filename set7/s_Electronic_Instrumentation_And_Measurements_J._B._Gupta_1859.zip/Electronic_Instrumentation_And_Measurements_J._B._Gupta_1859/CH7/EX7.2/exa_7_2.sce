mode(2);errcatch(-1,"stop");driver("GIF");// Exa 7.2
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_J._B._Gupta_1859/exa_7_2');xend();exit();
