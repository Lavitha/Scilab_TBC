errcatch(-1,"stop");mode(2);//Calculate output voltage and current through load and voltage across series resistor and current and power dissipated in zener diode
;
;
//soltion
//given
