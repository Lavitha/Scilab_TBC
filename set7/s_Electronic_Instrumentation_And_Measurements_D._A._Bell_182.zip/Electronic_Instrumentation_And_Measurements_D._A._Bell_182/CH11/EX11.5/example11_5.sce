mode(2);errcatch(-1,"stop");driver("GIF");// to find the output pulse width and capacitance for the given pulse width in figure 11-15
...
//C2=0.2 micro-F 
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_D._A._Bell_182/example11_5');xend();exit();
