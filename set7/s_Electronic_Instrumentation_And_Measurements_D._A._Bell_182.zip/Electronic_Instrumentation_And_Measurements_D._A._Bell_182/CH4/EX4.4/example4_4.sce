mode(2);errcatch(-1,"stop");driver("GIF");// to determine the resistance values for the circuit in the figure4-7
...
//R3=100 ohm
//R4=4900 ohm
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_D._A._Bell_182/example4_4');xend();exit();
