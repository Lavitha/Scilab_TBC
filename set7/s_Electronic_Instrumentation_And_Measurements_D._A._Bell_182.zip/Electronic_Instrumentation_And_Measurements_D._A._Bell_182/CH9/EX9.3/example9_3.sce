mode(2);errcatch(-1,"stop");driver("GIF");// to find the amplitude,frequency and the phase difference b/w two waveforms in the figure 9-20
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_D._A._Bell_182/example9_3');xend();exit();
