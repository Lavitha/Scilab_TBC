mode(2);errcatch(-1,"stop");driver("GIF");// to find the peak to peak voltage and the time period for the sweep generator circuit in fig 9-7
...
ylabel('voltage in V');
set(gca(),"grid",[1 1]);
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_D._A._Bell_182/example9_2');xend();exit();
