mode(2);errcatch(-1,"stop");driver("GIF");// to find Cx and Rx of figure 8-7 for new balance
...
//Cx=212 pF
//Rx=26 M-ohm
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Instrumentation_And_Measurements_D._A._Bell_182/example8_10');xend();exit();
