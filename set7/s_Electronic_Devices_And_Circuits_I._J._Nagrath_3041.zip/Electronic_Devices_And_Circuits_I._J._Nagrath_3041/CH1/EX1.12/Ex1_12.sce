mode(2);errcatch(-1,"stop");driver("GIF");//Variable declaration
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_I._J._Nagrath_3041/Ex1_12');xend();exit();
