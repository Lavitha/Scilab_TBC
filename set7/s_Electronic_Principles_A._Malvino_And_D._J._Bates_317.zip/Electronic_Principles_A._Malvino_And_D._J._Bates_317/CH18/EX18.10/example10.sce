mode(2);errcatch(-1,"stop");driver("GIF");// find closed-loop voltage gain, bandwidth and output voltage
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Principles_A._Malvino_And_D._J._Bates_317/example10');xend();exit();
