mode(2);errcatch(-1,"stop");driver("GIF");// find feedback fraction,ideal and exact closed-loop voltage gain,percent error
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Principles_A._Malvino_And_D._J._Bates_317/example1');xend();exit();
