mode(2);errcatch(-1,"stop");driver("GIF");// calculate ac output voltage and input impedance of the diff amp using second approximation
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Principles_A._Malvino_And_D._J._Bates_317/example5');xend();exit();
