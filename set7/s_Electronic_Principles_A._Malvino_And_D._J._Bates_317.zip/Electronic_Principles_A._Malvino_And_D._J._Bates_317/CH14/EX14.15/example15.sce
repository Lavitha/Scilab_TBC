mode(2);errcatch(-1,"stop");driver("GIF");// find Vgs,Id,gm,Vout
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Principles_A._Malvino_And_D._J._Bates_317/example15');xend();exit();
