errcatch(-1,"stop");mode(2);// find  d loop output impedance,short loaded current and voltage gain of the circuit
...
zoutcl=zoutol/(1+(Avol*B));// d-loop output impedance in ohms
