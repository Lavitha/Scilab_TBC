mode(2);errcatch(-1,"stop");driver("GIF");//Ex1_1 Pg-43
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_S._L._Kakani_And_K._C._Bhandari_2825/Ex1_1');xend();exit();
