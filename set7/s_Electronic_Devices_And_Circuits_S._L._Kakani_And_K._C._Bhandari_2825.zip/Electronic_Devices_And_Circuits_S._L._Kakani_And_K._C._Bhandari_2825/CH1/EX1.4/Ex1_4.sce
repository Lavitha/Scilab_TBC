mode(2);errcatch(-1,"stop");driver("GIF");//Ex1_4 Pg-44
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_S._L._Kakani_And_K._C._Bhandari_2825/Ex1_4');xend();exit();
