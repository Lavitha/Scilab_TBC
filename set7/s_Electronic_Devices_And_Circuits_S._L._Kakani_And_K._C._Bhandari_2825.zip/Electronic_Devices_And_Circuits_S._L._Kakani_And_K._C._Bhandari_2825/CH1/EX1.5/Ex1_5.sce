mode(2);errcatch(-1,"stop");driver("GIF");//Ex1_5 Pg-45
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_S._L._Kakani_And_K._C._Bhandari_2825/Ex1_5');xend();exit();
