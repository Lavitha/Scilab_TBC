mode(2);errcatch(-1,"stop");driver("GIF");// Example 3.25: (a) Output voltage waveform
//               (b) Transfer curve
clc, clear
t=[0:0.001:12];
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX25');xend();exit();
