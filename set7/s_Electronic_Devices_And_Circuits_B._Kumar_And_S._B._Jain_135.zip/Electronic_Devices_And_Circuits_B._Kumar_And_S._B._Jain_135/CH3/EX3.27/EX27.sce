mode(2);errcatch(-1,"stop");driver("GIF");// Example 3.27: vo vs vin
clc, clear
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX27');xend();exit();
