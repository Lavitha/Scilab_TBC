mode(2);errcatch(-1,"stop");driver("GIF");// Example 3.26: Transfer characteristics and output and input voltage
clc, clear
...
legend("vin","vo");
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX26');xend();exit();
