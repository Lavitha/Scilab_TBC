mode(2);errcatch(-1,"stop");driver("GIF");// Example 3.23: Output voltage and transfer characteristic curve
clc, clear
t=[-6:0.001:6];
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX23');xend();exit();
