mode(2);errcatch(-1,"stop");driver("GIF");// Example 7.6: VDSQ, IDQ
clc, clear
ID=6e-3; // in amperes
VGS=8; // in volts
VT=3; // in volts
...
disp(VGSQ,"VDSQ (V) =");
disp(IDQ,"IDQ (mA) =");
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX6');xend();exit();
