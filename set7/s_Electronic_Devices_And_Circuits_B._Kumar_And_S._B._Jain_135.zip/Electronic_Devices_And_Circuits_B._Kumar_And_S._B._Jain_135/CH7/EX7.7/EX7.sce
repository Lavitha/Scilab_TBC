mode(2);errcatch(-1,"stop");driver("GIF");// Example 7.7: IDQ, VDSQ, VGSQ
clc, clear
ID=5e-3; // in amperes
VGS=6; // in volts
VT=3; // in volts
...
disp(VDSQ,"VDSQ (V) =");
disp(VGSQ,"VGSQ (V) =");
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX7');xend();exit();
