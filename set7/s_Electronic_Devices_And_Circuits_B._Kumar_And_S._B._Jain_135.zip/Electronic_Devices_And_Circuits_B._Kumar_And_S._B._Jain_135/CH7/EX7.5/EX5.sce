mode(2);errcatch(-1,"stop");driver("GIF");// Example 7.5: Operating point
clc, clear
VP=-5; // in volts
...
disp(VDSQ,"VDSQ (V) =");
disp(IDQ,"IDQ (mA) =");
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX5');xend();exit();
