mode(2);errcatch(-1,"stop");driver("GIF");// Example 7.4: VDSQ, IDSQ, VD, VS
clc, clear
...
disp(VD,"VD (V) =");
disp(VS,"VS (V) =");
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX4');xend();exit();
