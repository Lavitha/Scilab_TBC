mode(2);errcatch(-1,"stop");driver("GIF");// Example 10.2: Bode's plots
clc, clear
w=[0:0.1:8];
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_B._Kumar_And_S._B._Jain_135/EX2');xend();exit();
