errcatch(-1,"stop");mode(2);// Example 10.12: (a) Approximate value of fH
//                (b) Approximate location of the st non-dominant pole
, 
RS=600; // in ohms
RC1=1.5e3; // in ohms
RC2=600; // in ohms
...
disp(f2,"Approximate location of the st non-dominant pole (MHz) =");
exit();
