mode(2);errcatch(-1,"stop");driver("GIF");//chapter 6
//example 6.2
//page 244
printf("\n")
printf("given")
...
Vce=Ic*Rc
xinit('/home/fossee/Downloads/tbc_graphs/Electronic_Devices_And_Circuits_D._A._Bell_226/example2_sce');xend();exit();
