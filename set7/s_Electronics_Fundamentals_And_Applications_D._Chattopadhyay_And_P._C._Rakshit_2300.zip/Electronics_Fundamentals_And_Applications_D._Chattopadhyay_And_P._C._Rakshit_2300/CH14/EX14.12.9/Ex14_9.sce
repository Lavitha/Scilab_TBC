mode(2);errcatch(-1,"stop");driver("GIF");//scilab 5.4.1
...
xinit('/home/fossee/Downloads/tbc_graphs/Electronics_Fundamentals_And_Applications_D._Chattopadhyay_And_P._C._Rakshit_2300/Ex14_9');xend();exit();
