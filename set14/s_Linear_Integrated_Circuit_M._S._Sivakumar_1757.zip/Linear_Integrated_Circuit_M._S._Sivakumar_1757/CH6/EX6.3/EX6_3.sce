errcatch(-1,"stop");mode(2);//Example6.3 // design an non-inverting amplifier with colsed loop gain of 5 limited voltage of -5 V <= Vo <= 5 V  and maximum i/p c/n 50 uA
;
;
