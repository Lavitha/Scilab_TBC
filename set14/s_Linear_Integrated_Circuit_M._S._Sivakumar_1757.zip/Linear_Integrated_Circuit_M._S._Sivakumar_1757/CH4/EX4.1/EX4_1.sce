errcatch(-1,"stop");mode(2);//Example 4.1 // For an op-amp circuit find a) d loop gain Acl b) input impedance Zin c) output impedance Zo
 ;
 ;
 ;
ro = 85 ; // ohm
...
ACL = abs(R2/R1) ;
disp('  d loop gain of an op-amp is = '+string(ACL)+'  '); // 1/beta = ACL
beta = (1/ACL) ;
