mode(2);errcatch(-1,"stop");driver("GIF");//caption:design_lead_compensator
//example 11_31
//page 339
s=%s;
clf();
...
xinit('/home/fossee/Downloads/tbc_graphs/Linear_Control_Systems_B._S._Manke__29/exa11_31');xend();exit();
