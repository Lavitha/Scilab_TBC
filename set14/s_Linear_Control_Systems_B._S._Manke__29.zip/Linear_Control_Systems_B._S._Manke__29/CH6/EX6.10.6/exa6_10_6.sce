errcatch(-1,"stop");mode(2);//Caption:time_response
//example 6.10.6
//page 174
...
cl=G/.H;//d_loop_transfer_function
d=denom(cl)/10;//taking 10 common from numerator and denominator for simplyfying d_loop_transfer_function
f=numer(cl)/10;
CL=f/d;//d_loop_transfer_function_after_simplifying
