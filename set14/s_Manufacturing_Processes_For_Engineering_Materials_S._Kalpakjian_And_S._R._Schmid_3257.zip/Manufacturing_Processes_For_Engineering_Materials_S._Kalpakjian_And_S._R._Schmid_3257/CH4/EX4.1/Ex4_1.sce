mode(2);errcatch(-1,"stop");driver("GIF");// Determination of coefficient of friction
clc
h = 20 // height in mm
...
xinit('/home/fossee/Downloads/tbc_graphs/Manufacturing_Processes_For_Engineering_Materials_S._Kalpakjian_And_S._R._Schmid_3257/Ex4_1');xend();exit();
