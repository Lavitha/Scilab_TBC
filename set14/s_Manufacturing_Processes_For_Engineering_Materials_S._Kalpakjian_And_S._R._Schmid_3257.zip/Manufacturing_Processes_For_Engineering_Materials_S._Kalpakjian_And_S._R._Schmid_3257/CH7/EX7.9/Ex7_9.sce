mode(2);errcatch(-1,"stop");driver("GIF");// Estimating cup diameter and earing
clc
r_0 = 0.9
r_45 = 1.3
r_90 = 1.9
...
xinit('/home/fossee/Downloads/tbc_graphs/Manufacturing_Processes_For_Engineering_Materials_S._Kalpakjian_And_S._R._Schmid_3257/Ex7_9');xend();exit();
