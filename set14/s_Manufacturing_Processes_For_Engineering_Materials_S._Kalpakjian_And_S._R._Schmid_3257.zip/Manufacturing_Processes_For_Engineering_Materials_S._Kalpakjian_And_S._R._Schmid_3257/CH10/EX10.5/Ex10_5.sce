mode(2);errcatch(-1,"stop");driver("GIF");// Analysis of plastic extruder
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/Manufacturing_Processes_For_Engineering_Materials_S._Kalpakjian_And_S._R._Schmid_3257/Ex10_5');xend();exit();
