mode(2);errcatch(-1,"stop");driver("GIF");// Determining the amount of phases in carbon steel
clc
m = 10 // mass in kg
...
xinit('/home/fossee/Downloads/tbc_graphs/Manufacturing_Processes_For_Engineering_Materials_S._Kalpakjian_And_S._R._Schmid_3257/Ex5_1');xend();exit();
