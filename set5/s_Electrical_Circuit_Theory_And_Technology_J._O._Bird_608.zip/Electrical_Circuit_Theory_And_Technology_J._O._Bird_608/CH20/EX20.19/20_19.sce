errcatch(-1,"stop");mode(2);//Problem 20.19: A 500 kVA transformer has a full load copper loss of 4 kW and an iron loss of 2.5 kW. Determine (a) the output kVA at which the efficiency of the transformer is a maximum, and (b) the maximum efficiency, assuming the power factor of the load is 0.75.
