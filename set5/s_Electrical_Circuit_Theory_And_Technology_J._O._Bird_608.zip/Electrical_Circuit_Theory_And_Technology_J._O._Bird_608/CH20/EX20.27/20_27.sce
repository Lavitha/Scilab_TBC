errcatch(-1,"stop");mode(2);//Problem 20.27: A three-phase transformer has 500 primary turns and 50 secondary turns. If the supply voltage is 2.4 kV find the secondary line voltage on no-load when the windings are connected a) star-delta, (b) delta-star.
