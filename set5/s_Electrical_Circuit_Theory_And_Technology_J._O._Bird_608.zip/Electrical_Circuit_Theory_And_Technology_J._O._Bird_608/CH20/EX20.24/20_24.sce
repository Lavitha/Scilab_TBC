errcatch(-1,"stop");mode(2);//Problem 20.24: An a.c. source of 24 V and internal resistance 15 kohm is matched to a load by a 25:1 ideal transformer. Determine (a) the value of the load resistance and (b) the power dissipated in the load.
