errcatch(-1,"stop");mode(2);//Problem 20.12: A single-phase transformer has 2000 turns on the primary and 800 turns on the secondary. Its no-load current is 5 A at a power factor of 0.20 lagging. Assuming the volt drop in the windings is negligible, determine the primary current and power factor when the secondary current is 100 A at a power factor of 0.85 lagging.
