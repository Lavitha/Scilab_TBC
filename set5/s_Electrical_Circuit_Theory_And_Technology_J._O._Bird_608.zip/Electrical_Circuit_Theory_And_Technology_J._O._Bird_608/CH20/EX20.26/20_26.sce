errcatch(-1,"stop");mode(2);//Problem 20.26: Determine the saving in the volume of copper used in an auto transformer compared with a double-wound transformer for (a) a 200 V:150 V transformer, and (b) a 500 V:100 V transformer.
