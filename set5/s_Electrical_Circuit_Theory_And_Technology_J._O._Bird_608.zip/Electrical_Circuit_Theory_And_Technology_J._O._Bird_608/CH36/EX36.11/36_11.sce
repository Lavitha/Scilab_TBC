mode(2);errcatch(-1,"stop");driver("GIF");//Problem 36.11: A supply voltage v given by
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_Circuit_Theory_And_Technology_J._O._Bird_608/36_11');xend();exit();
