errcatch(-1,"stop");mode(2);//Problem 38.07: The core of an inductor has a hysteresis loss of 40 W and an eddy current loss of 20 W when operating at 50 Hz frequency. (a) Determine the values of the losses if the frequency is increased to 60 Hz. (b) What will be the total core loss if the frequency is 50 Hz and the lamination are made one-half of their original thickness? Assume that the flux density remains unchanged in each case
