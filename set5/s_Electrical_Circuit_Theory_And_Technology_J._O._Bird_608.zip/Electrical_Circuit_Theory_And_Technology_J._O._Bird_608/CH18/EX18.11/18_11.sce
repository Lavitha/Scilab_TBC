errcatch(-1,"stop");mode(2);//Problem 18.11: In the differential amplifier shown in Figure 18.16, R1 = 10 kohm, R2 = 10 kohm, R3 = 100 kohm and Rf = 100 kohm. Determine the output voltage Vo if: 
//(a) V1 = 5 mV and V2 = 0 
//(b) V1 = 0 and V2 = 5mV 
