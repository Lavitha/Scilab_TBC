errcatch(-1,"stop");mode(2);//Problem 33.04:For the network shown in Figure 33.22, use Th´evenin’s theorem to determine the current flowing in the 80 ohm resistor.
