errcatch(-1,"stop");mode(2);//Problem 32.02:Use the superposition theorem to determine the current in the 4 ohm resistor of the network shown in Figure 32.11.
