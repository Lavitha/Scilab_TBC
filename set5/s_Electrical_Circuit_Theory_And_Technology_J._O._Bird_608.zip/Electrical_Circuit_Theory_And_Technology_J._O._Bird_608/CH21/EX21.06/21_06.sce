errcatch(-1,"stop");mode(2);//Problem 21.06: A d.c. generator running at 30 rev/s generates an e.m.f. of 200 V. Determine the percentage increase in the flux per pole required to generate 250 V at 20 rev/s.
