mode(2);errcatch(-1,"stop");driver("GIF");//Problem 17.02: A 4 μF capacitor is charged to 24 V and then discharged through a 220 kohms resistor. Use the ‘initial slope and three point’ method to draw: (a) the capacitor voltage/time characteristic, (b) the resistor voltage/time characteristic and (c) the current/time characteristic, for the transients which occur. From the characteristics determine the value of capacitor voltage, resistor voltage and current one and a half seconds after discharge has started.
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_Circuit_Theory_And_Technology_J._O._Bird_608/17_02');xend();exit();
