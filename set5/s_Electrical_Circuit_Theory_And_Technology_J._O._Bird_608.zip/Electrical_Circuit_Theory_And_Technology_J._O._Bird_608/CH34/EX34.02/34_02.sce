errcatch(-1,"stop");mode(2);//Problem 34.02: For the network shown in Figure 34.7, determine (a) the equivalent circuit impedance across terminals AB, (b) supply current I and (c) the power dissipated in the 10 ohm resistor.
...
//The network of Figure 34.7 is redrawn, as in Figure 34.8, showing more ly the part of the network 1, 2, 3 forming a delta connection  This may he transformed into a star connection as shown in Figure 34.9.
Z1 = ZA*ZB/(ZA + ZB + ZC)
Z2 = ZC*ZB/(ZA + ZB + ZC)
Z3 = ZA*ZC/(ZA + ZB + ZC)
