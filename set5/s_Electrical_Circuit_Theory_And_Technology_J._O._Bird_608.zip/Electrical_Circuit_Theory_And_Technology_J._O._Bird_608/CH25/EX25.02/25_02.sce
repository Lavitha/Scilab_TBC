errcatch(-1,"stop");mode(2);//Problem 25.02: Determine expressions for the impedance of the following admittances: (a)0.004/_30°S (b) (0.001-i0.002)S (c)(0.05 + i0.08)S
