errcatch(-1,"stop");mode(2);//Problem 42.01: Determine the cut-off frequency and the nominal impedance of each of the low-pass filter sections shown in Figure 42.19.
