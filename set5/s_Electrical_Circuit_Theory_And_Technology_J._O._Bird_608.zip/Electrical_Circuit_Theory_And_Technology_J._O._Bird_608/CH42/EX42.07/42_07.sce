errcatch(-1,"stop");mode(2);//Problem 42.07: A low-pass T section filter having a cut-off frequency of 15 kHz is connected in series with a high-pass T section filter having a cut-off frequency of 10 kHz. The terminating impedance of the filter is 600 ohm.(a) Determine the values of the components comprising the composite filter.
