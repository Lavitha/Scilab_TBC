errcatch(-1,"stop");mode(2);//Problem 42.05: Determine for each of the high-pass filter sections shown in Figure 42.27 (i) the cut-off frequency, and (ii) the nominal impedance.
