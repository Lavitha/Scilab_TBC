errcatch(-1,"stop");mode(2);//Problem 40.14: A ceramic capacitor is to be constructed to have a capacitance of 0.01 μF and to have a steady working potential of 2.5 kV maximum. Allowing a safe value of field stress of 10 MV/m, determine (a) the required thickness of the ceramic dielectric, (b) the area of plate required if the relative permittivity of the ceramic is 10, and (c) the maximum energy stored by the capacitor.
