errcatch(-1,"stop");mode(2);//Problem 41.07: For each of the attenuator networks shown in Figure 41.11, determine (a) the input resistance when the output port is open-circuited, (b) the input resistance when the output port is short-circuited, and (c) the characteristic impedance.
