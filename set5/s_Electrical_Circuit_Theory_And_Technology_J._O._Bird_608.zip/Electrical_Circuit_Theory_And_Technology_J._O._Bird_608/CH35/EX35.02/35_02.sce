errcatch(-1,"stop");mode(2);//Problem 35.02: If the load impedance Z in Figure 35.2 of problem 35.01 consists of variable resistance R and variable reactance X, determine (a) the value of Z that results in maximum power transfer, and (b) the value of the maximum power.
