errcatch(-1,"stop");mode(2);//Problem 35.05: Determine the value of the load resistance R shown in Figure 35.5 that gives maximum power dissipation and calculate the value of this power.
