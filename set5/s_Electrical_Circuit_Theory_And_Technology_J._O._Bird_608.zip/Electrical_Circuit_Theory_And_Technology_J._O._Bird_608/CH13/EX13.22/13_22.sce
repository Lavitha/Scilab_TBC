errcatch(-1,"stop");mode(2);//Problem 13.22: Find the value of the load resistor RL shown in Figure 13.51(a) that gives maximum power dissipation and determine the value of this power.
