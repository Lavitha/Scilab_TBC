errcatch(-1,"stop");mode(2);//Problem 43.11: For the coupled circuit shown in Figure 43.10, calculate (a) the self impedance of the primary circuit, (b) the self impedance of the secondary circuit, (c) the impedance reflected into the primary circuit, (d) the effective primary impedance, (e) the primary current, and (f) the secondary current
