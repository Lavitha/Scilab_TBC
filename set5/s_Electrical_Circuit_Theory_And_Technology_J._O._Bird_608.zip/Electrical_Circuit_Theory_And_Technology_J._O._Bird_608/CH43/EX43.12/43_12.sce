errcatch(-1,"stop");mode(2);//Problem 43.12:For the circuit shown in Figure 43.12 each winding is tuned to resonate at the same frequency. Determine (a) the reso-nant frequency, (b) the value of capacitor C2 , (c) the effective primary impedance, (d) the primary current, (e) the voltage across capacitor C2 and (f) the coefficient of coupling.
