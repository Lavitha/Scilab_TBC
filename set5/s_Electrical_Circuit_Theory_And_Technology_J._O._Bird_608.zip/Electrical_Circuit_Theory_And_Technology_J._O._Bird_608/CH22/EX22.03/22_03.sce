errcatch(-1,"stop");mode(2);//Problem 22.03: A three-phase 2-pole motor is to have a synchronous speed of 6000 rev/min. Calculate the frequency of the supply voltage.
