errcatch(-1,"stop");mode(2);//Problem 22.12: For the induction motor in problems 22.10 and 22.11, if the stator losses are 650 W, determine (a) the power input at full load, (b) the efficiency of the motor at full load and (c) the current taken from the supply at full load, if the motor runs at a power factor of 0.87 lagging.
