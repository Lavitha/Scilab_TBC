errcatch(-1,"stop");mode(2);//Problem 22.11: Determine for the induction motor in problem 22.10 at full load, (a) the rotor current, (b) the rotor copper loss, and (c) the starting current.
