mode(2);errcatch(-1,"stop");driver("GIF");//Ex5_2
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Image_Processing_R._C._Gonzalez_And_R._E._Woods_3176/Ex5_2');xend();exit();
