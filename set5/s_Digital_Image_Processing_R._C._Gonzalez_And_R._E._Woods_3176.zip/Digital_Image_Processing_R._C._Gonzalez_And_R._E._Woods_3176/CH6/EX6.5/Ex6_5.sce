mode(2);errcatch(-1,"stop");driver("GIF");//Ex6_5 : 
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Image_Processing_R._C._Gonzalez_And_R._E._Woods_3176/Ex6_5');xend();exit();
