mode(2);errcatch(-1,"stop");driver("GIF");//Ex10_4
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Image_Processing_R._C._Gonzalez_And_R._E._Woods_3176/Ex10_4');xend();exit();
