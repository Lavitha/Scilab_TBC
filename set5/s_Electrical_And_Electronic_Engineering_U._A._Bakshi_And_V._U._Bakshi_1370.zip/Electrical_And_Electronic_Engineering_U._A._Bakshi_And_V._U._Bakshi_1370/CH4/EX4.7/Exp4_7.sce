mode(2);errcatch(-1,"stop");driver("GIF");//Example 4.7
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Engineering_U._A._Bakshi_And_V._U._Bakshi_1370/Exp4_7');xend();exit();
