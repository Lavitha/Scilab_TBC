mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 10, Problem 10, figure 10.20
clc;
tc = 100E-6;            // in s/cm
Vc = 2;                 // in V/cm
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/10_10');xend();exit();
