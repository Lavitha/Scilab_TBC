mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 10, Problem 4, figure 10.10
clc;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/10_04');xend();exit();
