mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 6, figure 13.21
clc;
E1=8;                       //e.m.f source 1
E2=3;                       //e.m.f source 2
R=18                        //resistor
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_06');xend();exit();
