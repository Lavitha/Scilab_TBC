mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 3, Figure 13.7
clc;
A=[0.5 2;-5 7];
B=[16;12];
X=A\B;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_03');xend();exit();
