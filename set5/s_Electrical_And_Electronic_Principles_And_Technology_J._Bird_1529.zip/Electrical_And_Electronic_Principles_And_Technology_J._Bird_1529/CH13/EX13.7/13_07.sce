mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 7, figure 13.37
clc;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_07');xend();exit();
