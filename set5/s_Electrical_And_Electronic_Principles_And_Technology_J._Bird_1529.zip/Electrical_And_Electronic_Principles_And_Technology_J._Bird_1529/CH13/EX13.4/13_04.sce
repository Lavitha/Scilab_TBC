mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 4, Figure 13.9
clc;
I=8;                    //total current
A=[13 -11;16 32];
B=[54;112];
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_04');xend();exit();
