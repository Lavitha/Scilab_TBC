mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 13, figure 13.54
clc;
E=10;                      //e.m.f source 1
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_13');xend();exit();
