mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 13, Problem 14, figure 13.56
clc;
E1=4;                     //e.m.f source 1
E2=2;                     //e.m.f source 2
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/13_14');xend();exit();
