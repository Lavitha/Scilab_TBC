mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 18, Problem 11
clc;
...
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_And_Electronic_Principles_And_Technology_J._Bird_1529/18_11');xend();exit();
