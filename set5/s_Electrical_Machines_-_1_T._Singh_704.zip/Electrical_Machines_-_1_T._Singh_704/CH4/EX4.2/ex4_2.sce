errcatch(-1,"stop");mode(2);//Caption:In a three phase transformer Calculate the secondary line voltage at no load when windings star delta connected and delta star connected.
//Exam:4.2
;
;
