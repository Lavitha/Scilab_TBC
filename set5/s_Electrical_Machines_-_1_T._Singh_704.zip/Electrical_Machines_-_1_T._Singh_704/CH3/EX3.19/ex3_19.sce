errcatch(-1,"stop");mode(2);//Caption:In a single phase transformer Determine equivalent resistance referred to secondary side and equivalent reactance referred to secondary side
//Exam:3.19
;
;
