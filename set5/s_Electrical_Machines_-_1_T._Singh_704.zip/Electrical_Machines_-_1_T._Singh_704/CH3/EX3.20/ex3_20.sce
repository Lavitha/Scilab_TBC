errcatch(-1,"stop");mode(2);//Caption:Determine equivalent resistance and reactance of primary referred to secondary and total resistance and reactance referred to secondary and equivalent resistance and reactance of secondary referred to primary and total resistance and reactance of secondary referred to primary.
//Exam:3.20
;
;
