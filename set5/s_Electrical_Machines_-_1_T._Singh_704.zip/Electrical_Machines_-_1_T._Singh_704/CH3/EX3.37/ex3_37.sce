errcatch(-1,"stop");mode(2);//Caption:In a auto transformer determine Transformation ratio secondary current primary current and number of turns across secondary if total number of turns is 250.
//Exam:3.37
;
;
