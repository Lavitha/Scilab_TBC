errcatch(-1,"stop");mode(2);//Caption:In a loss less transformer calculate (a)Number of turns on high voltage side (b)The primary current (c)The secondary current
//Exam:3.2
;
;
