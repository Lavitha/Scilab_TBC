errcatch(-1,"stop");mode(2);//Caption:In a transformer Calculate (a)Magnetising component of no load current (b)the iron loss (c)the maximum value of flux in the core.
//Exam:3.11
;
;
