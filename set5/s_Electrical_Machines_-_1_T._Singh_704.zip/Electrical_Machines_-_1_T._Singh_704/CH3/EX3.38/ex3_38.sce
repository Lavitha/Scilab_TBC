errcatch(-1,"stop");mode(2);//Caption:In an auto transformer determine current in different section and KVA output and power transferred inductively and power transferred conductively from input to output and saving in copper
//Exam:3.38
;
;
