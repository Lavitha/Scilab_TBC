errcatch(-1,"stop");mode(2);//Caption:In a single phase transformer Calculate the efficiency of full load current (a)at unity power factor (b)at a power factor of 0.8 ,also calculate the load at which the maximum efficiency occurs and what is it's value.
//Exam:3.30
;
;
