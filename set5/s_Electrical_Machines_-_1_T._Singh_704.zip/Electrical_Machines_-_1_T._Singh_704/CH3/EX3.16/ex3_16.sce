errcatch(-1,"stop");mode(2);//Caption:In a single phase transformer Calculate Equivalent resistance as referred to primary and Equivalent resistance as referred to secondary and Equivalent reactance as referred to both primary and secondary also find Equivalent impedence as referred to both primary and secondary.
//Exam:3.16
;
;
