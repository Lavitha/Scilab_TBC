errcatch(-1,"stop");mode(2);//Caption:In a single phase transformer Calculate (a)The efficiency at full load, unity power factor. (b)The efficiency at full load, 0.8 lagging power factor. (c)The efficiency at full load, 0.8 leading power factor.
//Exam:3.27
;
;
