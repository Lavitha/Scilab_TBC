errcatch(-1,"stop");mode(2);//Caption:In a shunt motor find the resistance required in series with the armature circuit to reduce the speed of motor by 50 percent
//Exam:2.35
;
;
