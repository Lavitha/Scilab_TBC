errcatch(-1,"stop");mode(2);//Caption:Find (a)Equivalent rotor current per phase (b)Stator current per phase (c)Power factor (d)Rotor input (e)Rotor copper losses (f)Torque (g)Mechanical power output from rotor (h)Stator input (i)Efficiency.Solve it by APPROXIMATE equivalent circuit method 
//Exa:11.12
;
;
