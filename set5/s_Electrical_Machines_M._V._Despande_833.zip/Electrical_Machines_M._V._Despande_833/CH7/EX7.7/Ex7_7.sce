errcatch(-1,"stop");mode(2);//Caption: Find (a)e.m.f generated at 750r.p.m for lap wound (b)e.m.f generated at 600r.p.m for wave wound (c)Speed to be driven for 400V for same flux per pole
//Exa:7.7
;
;
