mode(2);errcatch(-1,"stop");driver("GIF");C = 0.01; // capacitance of the capacitor in Farads
t1 = [0:0.001:0.1];
t2 = [0.101:0.001:0.3];
t3 = [0.301:0.001:0.6];
t4 = [0.601:0.001:0.7];
...
plot(t, V, "green")
xinit('/home/fossee/Downloads/tbc_graphs/Electrical_Engineering_Fundamentals_V._Del_Toro_293/eg2_6');xend();exit();
