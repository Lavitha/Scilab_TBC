mode(2);errcatch(-1,"stop");driver("GIF");//example 3.9
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Principals_And_Applications_D._P._Leach_And_A._P._Malvino_45/example_3_14');xend();exit();
