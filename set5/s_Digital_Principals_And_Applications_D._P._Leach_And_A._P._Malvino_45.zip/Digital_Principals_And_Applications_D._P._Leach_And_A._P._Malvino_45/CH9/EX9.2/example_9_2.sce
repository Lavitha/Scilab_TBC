mode(2);errcatch(-1,"stop");driver("GIF");//example 9.2
clc
clear
close
t1=100; // clock period
...
plot(t11)
plot(y)
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Principals_And_Applications_D._P._Leach_And_A._P._Malvino_45/example_9_2');xend();exit();
