mode(2);errcatch(-1,"stop");driver("GIF");//exmaple 2.1 
//7404
clc
close
clear
...
plot(outputc)
plot(y)
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Principals_And_Applications_D._P._Leach_And_A._P._Malvino_45/example_2_1');xend();exit();
