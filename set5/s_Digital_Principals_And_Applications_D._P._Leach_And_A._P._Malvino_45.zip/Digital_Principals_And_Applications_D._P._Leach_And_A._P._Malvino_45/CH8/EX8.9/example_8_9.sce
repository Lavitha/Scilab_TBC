mode(2);errcatch(-1,"stop");driver("GIF");//example 8.9
clc
close
clear
...
plot(dout)
plot(y)
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Principals_And_Applications_D._P._Leach_And_A._P._Malvino_45/example_8_9');xend();exit();
