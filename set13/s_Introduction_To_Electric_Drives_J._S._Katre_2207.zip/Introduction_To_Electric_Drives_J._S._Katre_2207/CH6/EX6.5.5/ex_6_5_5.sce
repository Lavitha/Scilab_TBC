mode(2);errcatch(-1,"stop");driver("GIF");//Example 6.5.5:average load voltage and rms load voltage
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Electric_Drives_J._S._Katre_2207/ex_6_5_5');xend();exit();
