mode(2);errcatch(-1,"stop");driver("GIF");// Example 3.4.1: plot the variation
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Electric_Drives_J._S._Katre_2207/ex_3_4_1');xend();exit();
