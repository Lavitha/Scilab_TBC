errcatch(-1,"stop");mode(2);// Example 3.7.6:average output voltage,supply rms current ,supply fundamental current current,displacement factor,supply factor and supply harmonic factor
;
;
