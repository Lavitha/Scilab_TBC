mode(2);errcatch(-1,"stop");driver("GIF");//example 4.62
...
xinit('/home/fossee/Downloads/tbc_graphs/Irrigation_And_Water_Power_Engineering_B._C._Punmia_2087/example4_62');xend();exit();
