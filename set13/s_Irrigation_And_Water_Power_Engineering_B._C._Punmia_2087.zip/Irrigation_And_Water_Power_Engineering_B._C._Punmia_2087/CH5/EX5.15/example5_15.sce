mode(2);errcatch(-1,"stop");driver("GIF");//example 5.15
...
xinit('/home/fossee/Downloads/tbc_graphs/Irrigation_And_Water_Power_Engineering_B._C._Punmia_2087/example5_15');xend();exit();
