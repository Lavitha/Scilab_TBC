...
printf("\n(i) The uncertainty in the momentum of electron = %.3e kg m/s\n(ii) Kinetic energy of electron = %.0f MeV\n   Experiments show that energy of electrons in nu disintegration (beta decay) is very much less than %.0f MeV. Hence the uncertainty principle rules out the possibility of electrons being a nu constituent.",p_uncer,T,T);
