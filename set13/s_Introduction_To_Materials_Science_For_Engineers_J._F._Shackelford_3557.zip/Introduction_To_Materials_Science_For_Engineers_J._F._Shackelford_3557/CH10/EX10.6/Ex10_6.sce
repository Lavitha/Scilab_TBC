mode(2);errcatch(-1,"stop");driver("GIF");//Example 10.6//
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Materials_Science_For_Engineers_J._F._Shackelford_3557/Ex10_6');xend();exit();
