mode(2);errcatch(-1,"stop");driver("GIF"); //Example 17.9//
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Materials_Science_For_Engineers_J._F._Shackelford_3557/Ex17_9');xend();exit();
