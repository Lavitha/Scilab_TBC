mode(2);errcatch(-1,"stop");driver("GIF");pathname=get_absolute_file_path('602.sce')
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Flight_J._D._Anderson_Jr._548/602');xend();exit();
