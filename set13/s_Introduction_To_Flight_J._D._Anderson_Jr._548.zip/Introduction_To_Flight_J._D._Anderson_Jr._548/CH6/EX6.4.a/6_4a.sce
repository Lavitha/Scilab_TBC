mode(2);errcatch(-1,"stop");driver("GIF");pathname=get_absolute_file_path('6_4a.sce')
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Flight_J._D._Anderson_Jr._548/6_4a');xend();exit();
