mode(2);errcatch(-1,"stop");driver("GIF");//Performance curves//
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Fluid_Mechanics_R._W._Fox_And_A._T._Mcdonald_812/10_11');xend();exit();
