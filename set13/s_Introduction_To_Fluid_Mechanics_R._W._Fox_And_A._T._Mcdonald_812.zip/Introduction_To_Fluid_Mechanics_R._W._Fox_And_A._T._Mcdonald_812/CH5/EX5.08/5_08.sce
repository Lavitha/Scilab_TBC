mode(2);errcatch(-1,"stop");driver("GIF");//Rates and area//
...
xinit('/home/fossee/Downloads/tbc_graphs/Introduction_To_Fluid_Mechanics_R._W._Fox_And_A._T._Mcdonald_812/5_08');xend();exit();
