mode(2);errcatch(-1,"stop");driver("GIF");// Example 11.10
clear all;
clc;
...
xinit('/home/fossee/Downloads/tbc_graphs/_introduction_to_nuclear_engineering_J._R._Lamarsh_And_A._J._Baratta_3269/Ex11_10');xend();exit();
