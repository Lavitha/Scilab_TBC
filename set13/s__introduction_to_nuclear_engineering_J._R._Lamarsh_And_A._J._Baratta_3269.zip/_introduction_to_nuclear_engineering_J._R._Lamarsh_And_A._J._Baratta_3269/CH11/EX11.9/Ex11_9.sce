errcatch(-1,"stop");mode(2);// Example 11.9
 all;
;
...
// Using assumption 2 of Nu Regulatory Commission (NRC) in calculation of radii of exclusion zone and Low Population Zone (LPZ)
