mode(2);errcatch(-1,"stop");driver("GIF");//Initlization of  variables
F1=2000 //lb
w=100 //lb/ft
//Calculations
...
xinit('/home/fossee/Downloads/tbc_graphs/Engineering_Mechancis-schaum_Series_Mclean_3137/Ex8_5');xend();exit();
