errcatch(-1,"stop");mode(2);// Scilab Code Ex5.7 :: Page-5.32 (2009)
;;
...
P = E/t;    // Total power output of the nu reactor, MeV per second
printf("\nThe total power output of the nu reactor = %4.2e MeV per second", P);

// Result
// The total power output of the nu reactor = 2.97e+22 MeV per second 
