mode(2);errcatch(-1,"stop");driver("GIF");// chapter 7 , Example 7.2 , pg 208
...
xinit('/home/fossee/Downloads/tbc_graphs/Engineering_Physics__D._K._Bhattacharya_1952/Ex7_2');xend();exit();
