mode(2);errcatch(-1,"stop");driver("GIF");//Harriot P.,2003,Chemical Reactor Design (I-Edition) Marcel Dekker,Inc., USA,pp 436.
...
xinit('/home/fossee/Downloads/tbc_graphs/Chemical_Reactor_Design_P._Harriott_1040/Chapter5_Ex3_a');xend();exit();
