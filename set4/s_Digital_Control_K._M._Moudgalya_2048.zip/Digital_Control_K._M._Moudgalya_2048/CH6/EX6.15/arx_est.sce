mode(2);errcatch(-1,"stop");driver("GIF");// Determination of ARX parameters as described in Example 6.25 on page 203.
// 6.15
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/arx_est');xend();exit();
