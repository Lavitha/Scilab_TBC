mode(2);errcatch(-1,"stop");driver("GIF");// Determination of ARMAX parameters as described in Example 6.27 on page 206.
// 6.16
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/armax_est');xend();exit();
