mode(2);errcatch(-1,"stop");driver("GIF");// Implementation of trial and error procedure to determine ARMA(1,1) process, presented in Example 6.20 on page 191.
// 6.13
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/arma_ex');xend();exit();
