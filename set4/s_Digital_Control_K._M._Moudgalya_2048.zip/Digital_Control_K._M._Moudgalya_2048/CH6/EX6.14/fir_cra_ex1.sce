mode(2);errcatch(-1,"stop");driver("GIF");// Determination of FIR parameters as described in Example 6.22 on page 200.
// 6.14
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/fir_cra_ex1');xend();exit();
