mode(2);errcatch(-1,"stop");driver("GIF");// Illustration of nonuniqueness in estimation of MA model parameters using ACF, discussed in Example 6.14 on page 184
// 6.7
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/unique_ma');xend();exit();
