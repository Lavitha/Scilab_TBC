mode(2);errcatch(-1,"stop");driver("GIF");// Determination of OE parameters as described in Example 6.28 on page 209.
// 6.17
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/oe_est');xend();exit();
