mode(2);errcatch(-1,"stop");driver("GIF");// Procedure to plot the ACF, as discussed in Sec. 6.4.3. An example usage is given in 6.5.
// 6.6
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/plotacf.sci');xend();exit();
