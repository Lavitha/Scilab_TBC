mode(2);errcatch(-1,"stop");driver("GIF");// Performance curve for LQG control design of viscosity problem
// 13.9
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/lqg_visc_loop');xend();exit();
