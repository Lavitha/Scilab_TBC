mode(2);errcatch(-1,"stop");driver("GIF");// Performance curve for GMVC design of MacGregor's first control problem
// 13.10
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/gmv_mac1_loop');xend();exit();
