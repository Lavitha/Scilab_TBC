mode(2);errcatch(-1,"stop");driver("GIF");// A procedure to design lead controllers, as explained in Fig. 7.12 on page 257.
// 7.4
...
xinit('/home/fossee/Downloads/tbc_graphs/Digital_Control_K._M._Moudgalya_2048/lead_lag');xend();exit();
