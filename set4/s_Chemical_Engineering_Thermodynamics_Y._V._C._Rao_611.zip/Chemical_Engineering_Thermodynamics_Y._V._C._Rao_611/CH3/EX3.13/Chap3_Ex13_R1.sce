mode(2);errcatch(-1,"stop");driver("GIF");// Y.V.C.Rao ,1997.Chemical Engineering Thermodynamics.Universities Press,Hyderabad,India.
...
xinit('/home/fossee/Downloads/tbc_graphs/Chemical_Engineering_Thermodynamics_Y._V._C._Rao_611/Chap3_Ex13_R1');xend();exit();
