mode(2);errcatch(-1,"stop");driver("GIF");//Example 13.7
...
printf("\nC2=%.f nF",C2*10^9);
xinit('/home/fossee/Downloads/tbc_graphs/Design_With_Operational_Amplifiers_And_Analog_Integrated_Circuits_S._Franco_929/Example13_7');xend();exit();
