mode(2);errcatch(-1,"stop");driver("GIF");//Example 1.16
...
xinit('/home/fossee/Downloads/tbc_graphs/Design_With_Operational_Amplifiers_And_Analog_Integrated_Circuits_S._Franco_929/Example1_16');xend();exit();
