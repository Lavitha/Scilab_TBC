mode(2);errcatch(-1,"stop");driver("GIF");//Example sec 9.1
...
xinit('/home/fossee/Downloads/tbc_graphs/Control_Engineering_-_Theory_And_Practice_M._N._Bandyopadhyay_1299/examplesec9_1');xend();exit();
