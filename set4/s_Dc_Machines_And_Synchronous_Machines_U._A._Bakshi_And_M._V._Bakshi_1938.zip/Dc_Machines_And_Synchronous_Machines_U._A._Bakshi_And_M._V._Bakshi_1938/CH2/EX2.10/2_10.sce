mode(2);errcatch(-1,"stop");driver("GIF");clc,clear
printf('Example 2.10\n\n')
...
xinit('/home/fossee/Downloads/tbc_graphs/Dc_Machines_And_Synchronous_Machines_U._A._Bakshi_And_M._V._Bakshi_1938/2_10');xend();exit();
