...
;;
//example 19.9w
//calculation of the power of lens and maximum distance that can be seen ly
...
d=1/((1/vdash)-(1/f))//maximum distance for  vision.... by using the lens formula

printf('the power of the lens is %3.1f D',P)
printf('\nthe maximum distance upto which,the person will be able to see ly is %d cm',round(abs(d*10^2)))
