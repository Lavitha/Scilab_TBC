mode(2);errcatch(-1,"stop");driver("GIF");//developed in windows XP operating system 32bit
...
xinit('/home/fossee/Downloads/tbc_graphs/Concepts_Of_Physics_(volume_-_1)_H._C._Verma_2084/2_18w');xend();exit();
