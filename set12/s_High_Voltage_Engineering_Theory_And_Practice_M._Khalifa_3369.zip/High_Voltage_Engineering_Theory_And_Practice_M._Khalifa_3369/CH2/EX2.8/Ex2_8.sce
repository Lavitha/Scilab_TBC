mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 2, Exmaple 8, page 70
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Voltage_Engineering_Theory_And_Practice_M._Khalifa_3369/Ex2_8');xend();exit();
