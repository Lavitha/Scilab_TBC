mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 16,Example 9,page 563
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Voltage_Engineering_Theory_And_Practice_M._Khalifa_3369/Ex16_9');xend();exit();
