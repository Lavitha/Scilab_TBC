mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 16,Example 10,page 564
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Voltage_Engineering_Theory_And_Practice_M._Khalifa_3369/Ex16_10');xend();exit();
