mode(2);errcatch(-1,"stop");driver("GIF");//Example 7.8, page no-441
clear
clc
D=80
W=66.5
...
xinit('/home/fossee/Downloads/tbc_graphs/Industrial_Instrumentation_K._Krishnaswamy_And_S._Vijayachitra_1436/ex7_8');xend();exit();
