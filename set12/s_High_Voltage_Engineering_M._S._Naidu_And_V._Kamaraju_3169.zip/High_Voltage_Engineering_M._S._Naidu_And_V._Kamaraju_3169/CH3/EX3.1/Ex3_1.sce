mode(2);errcatch(-1,"stop");driver("GIF");//developed in windows XP operating system
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Voltage_Engineering_M._S._Naidu_And_V._Kamaraju_3169/Ex3_1');xend();exit();
