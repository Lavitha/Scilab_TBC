errcatch(-1,"stop");mode(2);//Chapter 10_Special Purpose Amplifiers
//Caption : Class B Power Amplifier
//Example10.3: A class-B audio power amplifier has a supply voltage of  abs(Vcc)=15V. The d loop gain Av=50 and the amplifier has to deliver 10W of power into an 8 ohm load.Find:
