mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 5, Problem 22, figure 5.58
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/5_22');xend();exit();
