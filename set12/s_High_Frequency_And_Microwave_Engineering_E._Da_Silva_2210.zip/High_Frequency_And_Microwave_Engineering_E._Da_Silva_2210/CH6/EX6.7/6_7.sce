mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 6, Problem 7, figure 6.13
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/6_7');xend();exit();
