mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 3, Prblem 17, figure 3.34
clc
funcprot(0)
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/3_17');xend();exit();
