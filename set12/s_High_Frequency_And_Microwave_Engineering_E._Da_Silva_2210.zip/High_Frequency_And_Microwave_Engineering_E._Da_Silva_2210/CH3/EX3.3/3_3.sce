mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 3, Problem 3
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/3_3');xend();exit();
