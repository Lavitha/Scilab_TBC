mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 3, Problem 11, Figure 3.16(a), 3.18
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/3_11');xend();exit();
