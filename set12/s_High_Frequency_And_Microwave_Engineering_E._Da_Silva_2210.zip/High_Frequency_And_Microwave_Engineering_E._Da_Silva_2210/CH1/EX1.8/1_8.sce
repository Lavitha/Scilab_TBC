mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 1, Example 1.8, figure 1.23
clc
n=3                         //no of recievers
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/1_8');xend();exit();
