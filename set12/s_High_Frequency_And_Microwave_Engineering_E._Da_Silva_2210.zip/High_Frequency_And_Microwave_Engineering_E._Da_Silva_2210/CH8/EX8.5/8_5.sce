mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 8, Problem 5, figure 8.28
clc
...
xinit('/home/fossee/Downloads/tbc_graphs/High_Frequency_And_Microwave_Engineering_E._Da_Silva_2210/8_5');xend();exit();
