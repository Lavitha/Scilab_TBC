...
hc=42000;//Contact Conductance coreesponding to copper-aluminium interface for the case of 1.17-1.4 micron roughness and 5MPa[pressure, which is  to given to what we have[W/m^2.K]
