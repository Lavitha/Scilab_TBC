mode(2);errcatch(-1,"stop");driver("GIF");//Engineering and Chemical Thermodynamics
//Example 6.13
//Page no :287
...
xinit('/home/fossee/Downloads/tbc_graphs/Engineering_And_Chemical_Thermodynamics_M._D._Koretsky_527/6_13exam');xend();exit();
