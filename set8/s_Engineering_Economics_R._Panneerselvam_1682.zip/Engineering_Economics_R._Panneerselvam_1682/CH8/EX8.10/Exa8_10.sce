errcatch(-1,"stop");mode(2);//Exa 8.10
;
;
...
disp("From table it is  that the avg cost/month is minimum for the 3rd month. Hence, the group replacement period is 3 months.");
