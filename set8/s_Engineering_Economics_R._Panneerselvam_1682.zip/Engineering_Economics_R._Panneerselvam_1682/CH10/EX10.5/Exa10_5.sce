errcatch(-1,"stop");mode(2);//Exa 10.5
;
;
...
disp("From the computations it is  that only alternative A is eligible because other two alternatives have BC ratio less than one.")
exit();
