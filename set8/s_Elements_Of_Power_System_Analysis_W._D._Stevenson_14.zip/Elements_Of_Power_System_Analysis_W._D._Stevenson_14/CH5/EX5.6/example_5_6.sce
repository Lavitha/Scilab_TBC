mode(2);errcatch(-1,"stop");driver("GIF");//Chapter 5
//Example_5_6
//Page 119
//reflection
clear;clc;
...
xinit('/home/fossee/Downloads/tbc_graphs/Elements_Of_Power_System_Analysis_W._D._Stevenson_14/example_5_6');xend();exit();
