mode(2);errcatch(-1,"stop");driver("GIF");// Exa 4.1
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Fundamentals_Of_Electronic_Devices_And_Circuits_J._B._Gupta_2444/ex4_1');xend();exit();
