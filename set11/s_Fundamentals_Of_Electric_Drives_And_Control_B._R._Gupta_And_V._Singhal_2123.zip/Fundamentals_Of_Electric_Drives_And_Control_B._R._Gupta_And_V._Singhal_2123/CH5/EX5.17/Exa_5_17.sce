mode(2);errcatch(-1,"stop");driver("GIF");//Example No. 5.17
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Fundamentals_Of_Electric_Drives_And_Control_B._R._Gupta_And_V._Singhal_2123/Exa_5_17');xend();exit();
