mode(2);errcatch(-1,"stop");driver("GIF");//All the quantities are expressed in SI units
...
xinit('/home/fossee/Downloads/tbc_graphs/Fundamentals_Of_Aerodynamics_J._D._Anderson_Jr._494/9_3');xend();exit();
