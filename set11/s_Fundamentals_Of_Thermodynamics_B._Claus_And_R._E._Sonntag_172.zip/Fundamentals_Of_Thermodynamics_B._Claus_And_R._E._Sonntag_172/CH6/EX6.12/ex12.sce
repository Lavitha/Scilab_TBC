mode(2);errcatch(-1,"stop");driver("GIF");//example 12
...
xinit('/home/fossee/Downloads/tbc_graphs/Fundamentals_Of_Thermodynamics_B._Claus_And_R._E._Sonntag_172/ex12');xend();exit();
