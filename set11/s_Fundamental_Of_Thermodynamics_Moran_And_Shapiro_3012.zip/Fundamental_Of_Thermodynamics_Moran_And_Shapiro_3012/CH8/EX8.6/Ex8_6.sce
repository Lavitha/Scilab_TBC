...
// The condensate leaving the d heater is saturated at 2 MPa. From Table A-3,
h12 = 908.79                                                                    // in kj/kg
h13 = h12                                                                       // since The fluid passing through the trap undergoes a throttling process
// For the feedwater exiting the d heater
hf = 875.1                                                                      // in kj/kg
...
ydash = (h11-h10)/(h2-h12)                                                      // the fraction of the total flow diverted to the d heater
