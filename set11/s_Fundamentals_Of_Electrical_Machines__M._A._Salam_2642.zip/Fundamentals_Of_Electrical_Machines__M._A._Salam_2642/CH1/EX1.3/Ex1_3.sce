mode(2);errcatch(-1,"stop");driver("GIF");// FUNDAMENTALS OF ELECTICAL MACHINES 
// M.A.SALAM 
...
xinit('/home/fossee/Downloads/tbc_graphs/Fundamentals_Of_Electrical_Machines__M._A._Salam_2642/Ex1_3');xend();exit();
