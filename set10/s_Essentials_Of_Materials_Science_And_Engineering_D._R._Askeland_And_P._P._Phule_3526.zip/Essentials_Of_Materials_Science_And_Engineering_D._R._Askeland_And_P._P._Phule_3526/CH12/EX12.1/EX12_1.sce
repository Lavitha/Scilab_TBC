mode(2);errcatch(-1,"stop");driver("GIF");clc;funcprot(0);//EXAMPLE 12.1
//page 347
...
xinit('/home/fossee/Downloads/tbc_graphs/Essentials_Of_Materials_Science_And_Engineering_D._R._Askeland_And_P._P._Phule_3526/EX12_1');xend();exit();
