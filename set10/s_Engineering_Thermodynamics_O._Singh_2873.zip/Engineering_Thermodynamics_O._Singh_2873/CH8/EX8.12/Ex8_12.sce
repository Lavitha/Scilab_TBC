...
h9=h8+v8*(20-4)*10^2
disp("Let us apply heat balance at d feed water heater,")
...
disp("from steam tables,at 0.075 bar,hf=168.76 KJ/kg,hfg=2406.0 KJ/kg")
h5_a=hf+x5_a*hfg
disp("Let mass of bled steam at 20 bar and 4 bar be m1_a,m2_a per kg of steam generated.Applying heat balance at d feed water heater.")
