...
disp("for d feed water heater,energy balance yields;")
disp("m6*h6+h10=m6*h7+h11")
disp("assuming condensate leaving d feed water heater to be saturated liquid,")
...
disp("substituting in energy balance upon d feed water heater,")
