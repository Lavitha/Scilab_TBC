...
disp("By heat balance on first d feed water heater,(see schematic arrangement)")
disp("h11=hf at 6 bar=670.56 KJ")
h11=670.56;
disp("m1*h3_a+h10=m1*h11+4.18*150")
disp("(m1*2829.63)+h10=(m1*670.56)+627")
disp("h10+2159.07*m1=627")
disp("By heat balance on second d feed water heater,(see schematic arrangement)")
