...
h5=137.82;
v5=0.001005;
disp("Let mass of steam bled for feed heating be m kg/kg of steam generated in boiler.Let us also assume that condensate leaves d feed water heater as saturated liquid i.e")
...
disp("Applying energy balance at d feed water heater;")
