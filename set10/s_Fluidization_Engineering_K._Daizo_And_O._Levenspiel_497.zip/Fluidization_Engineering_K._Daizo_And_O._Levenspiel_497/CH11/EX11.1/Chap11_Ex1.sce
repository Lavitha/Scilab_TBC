mode(2);errcatch(-1,"stop");driver("GIF");//Kunii D., Levenspiel O., 1991. Fluidization Engineering(II Edition). Butterworth-Heinemann, MA, pp 491
...
//====================================END OF PROGRAM ======================================================
xinit('/home/fossee/Downloads/tbc_graphs/Fluidization_Engineering_K._Daizo_And_O._Levenspiel_497/Chap11_Ex1');xend();exit();
