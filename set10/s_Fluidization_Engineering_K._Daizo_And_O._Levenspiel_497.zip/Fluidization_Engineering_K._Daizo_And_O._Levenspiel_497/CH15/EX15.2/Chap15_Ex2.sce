errcatch(-1,"stop");mode(2);//Kunii D., Levenspiel O., 1991. Fluidization Engineering(II Edition). Butterworth-Heinemann, MA, pp 491
...
//Disclaimer: The values of F2/F1 obtained by manual calculation has  correspondance to the ones obtained as the output, whereas it deviates largely from the values given in textbook.
