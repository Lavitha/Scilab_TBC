mode(2);errcatch(-1,"stop");driver("GIF");//Example 13.1: plot
clc;
clear;
...
xinit('/home/fossee/Downloads/tbc_graphs/Fiber_Optics_And_Optoelectronics_R._P._Khare_2216/ex_13_1');xend();exit();
