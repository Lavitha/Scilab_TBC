errcatch(-1,"stop");mode(2);//caption:amplifier parameters
...
//d-loop gain,Avf
disp('d-loop gain, Avf=Av/C,where C=1+Av*Bv');
Avf=Av/C;
//d-loop input resistance,rif
disp('d-loop input resistance, rif=ri*C');
rif=ri*C;
//d-loop output resistance, rof
disp('d-loop output resistance, rof=ro/C,where C=1+Av*Bv');
rof=ro/C;
printf("RESULTS:\n");
