...
disp('The phase angle of A is very  to -90degrees=%pi/2 radians');
...
Av2=abs(Av);
M=Av/Av2;
printf(" The d-loop gain at the cross over point is thus reduced by a factor %f and therefore point corresponds to upper half-power frequency which is 90KHz",M)
...
BW=fh-fl;
printf(" RESULTS:\n");
printf(" The d-loop bandwidth is %d KHz",BW);
exit();
